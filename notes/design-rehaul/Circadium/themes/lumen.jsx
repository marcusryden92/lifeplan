            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    You have <strong style={{ fontWeight: 700 }}>2h 18m</strong>{" "}
                    of unscheduled focus on Thursday. Hold it, or use it?
                  </div>
          ...
          >
            ...
            >
              ...
              <div style={{ display: "flex", gap: 4, marginLeft: 6 }}>
                <button style={{ ...btnGlass(t), padding: "6px 10px" }}>
                  ‹
                </button>
                <button style={{ ...btnGlass(t), padding: "6px 12px" }}>
                  Today
                </button>
                <button style={{ ...btnGlass(t), padding: "6px 10px" }}>
                  ›
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {goal.done} of {goal.total} subtasks · {goal.totalDur}{" "}
                      total
                    </span>
                  </div>
                  <span
              ...
              >
                ...
                >
                  ...
                  <div style={{ ...g, borderRadius: 20, padding: "16px 18px" }}>
                    ...
                    >
                      {["estimate", "split", "tighten", "add taper"].map(
                        (c) => (
                          <span
                            key={c}
                            style={{
